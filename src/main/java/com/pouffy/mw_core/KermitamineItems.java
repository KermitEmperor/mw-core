...
public class KermitamineItems {
    ...
    public static final RegistryObject<Item> SUPERPOSITIONED_KERMITAMINE_CRYSTAL = KERMIT_ITEMS.register("superpositioned_kermitamine_crystal",
            () -> new Item(new Item.Properties().tab(MWCore.KERMITAMINE)));
    public static final RegistryObject<Item> KERMITAMINE_CRYSTAL_LAMBDA_ = KERMIT_ITEMS.register("kermitamine_crystal_lambda_",
            () -> new Item(new Item.Properties().tab(MWCore.KERMITAMINE)));
    public static final RegistryObject<Item> UNSTABLE_KERMITAMINE_CRYSTAL_LAMBDA_ = KERMIT_ITEMS.register("unstable_kermitamine_crystal_lambda_",
            () -> new Item(new Item.Properties().tab(MWCore.KERMITAMINE)));
    ...
    public static final RegistryObject<Item> SUPERPOSITIONED_HANSONETIC_CRYSTAL = KERMIT_ITEMS.register("superpositioned_hansonetic_crystal",
            () -> new Item(new Item.Properties().tab(MWCore.KERMITAMINE)));
    public static final RegistryObject<Item> HANSONETIC_CRYSTAL_LAMBDA_ = KERMIT_ITEMS.register("hansonetic_crystal_lambda_",
            () -> new Item(new Item.Properties().tab(MWCore.KERMITAMINE)));
    public static final RegistryObject<Item> UNSTABLE_HANSONETIC_CRYSTAL_LAMBDA_ = KERMIT_ITEMS.register("unstable_hansonetic_crystal_lambda_",
            () -> new Item(new Item.Properties().tab(MWCore.KERMITAMINE)));
